...
water_mp3_file = 'Love You Oye.mp3'

# Eye Exercise Configuration:
eye_exercise_interval = 1 * 60  # Every 30 minutes
eye_mp3_file = 'Love You Oye.mp3'

# Physical Exercise Configuration:
physical_exercise_interval = 30  # Every 45 minutes
physical_mp3_file = 'Love You Oye.mp3'
